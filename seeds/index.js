...
const seedDB = async () => {
    ...
    for (let i = 0; i < 300; i++) {
        ...
        const camp = new Campground({
            ...
            images: [
                {
                    url: 'https://res.cloudinary.com/dp0ke6sps/image/upload/v1654604525/YelpCamp/ruyoaxgf72nzpi4y6cdi_otukgs.png',
                    filename: 'YelpCamp/ruyoaxgf72nzpi4y6cdi_otukgs'
                },
                {
                    url: 'https://res.cloudinary.com/dp0ke6sps/image/upload/v1654604554/YelpCamp/ahfnenvca4tha00h2ubt_raqndn.png',
                    filename: 'YelpCamp/ahfnenvca4tha00h2ubt_raqndn'
                }
            ]
        })
        await camp.save()
